  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
                <div component="$UI/system/components/justep/titleBar/titleBar" title="选择题"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">选择题</div>  
   ...
   <div xid="div1" bind-text='$model.using.val("ques")'></div><span component="$UI/system/components/justep/select/radioGroup" class="x-radio-group x-radio-group-vertical x-radios x-edit" xid="radioGroup1" bind-itemset="using" bind-itemsetValue="ref('chooseId')" bind-itemsetLabel="ref('choose')"></span></div>
  </div>
...
<span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog2" title="提示" message="已提交!"></span>
