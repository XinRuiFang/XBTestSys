define(function(require){
	...
	Model.prototype.quesCustomRefresh = function(event){
		var url = require.toUrl("./main/json/judge.json");
	...
	Model.prototype.button5Click = function(event){
		...
		else
		{
			...
			if(answer == choose)
			{
				...
				var wrongI = window.localStorage.getItem("simWrongItemJudge");
				...
				window.localStorage.setItem("simWrongItemJudge",JSON.stringify(wrongItem));
				var a = wrongItem.length;
				if(window.localStorage.getItem("wrongJudgeTotalOf"))
				{
					window.localStorage.setItem("wrongJudgeTotalOf",a);
				}
				else
				{						
	...
	Model.prototype.messageDialog7OK = function(event){
		window.localStorage.removeItem("simWrongItemJudge");
