...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column label="A" name="A" type="String" xid="xid16"></column>
  <column label="B" name="B" type="String" xid="xid17"></column>
  <column label="C" name="C" type="String" xid="xid18"></column>
  <column label="D" name="D" type="String" xid="xid19"></column>
  ...
  <span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog1" title="提示" message="答案正确！下次作答时此题会从错题库中移除"></span><div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
                <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="错题-分类选择">
   ...
   <div class="x-titlebar-title" xid="title1">错题-分类选择</div>
   ...
   <div xid="div1" bind-text='$model.queswrong.val("id") +"."+$model.using.val("ques")'></div><span component="$UI/system/components/justep/select/radioGroup" class="x-radio-group x-radio-group-vertical x-radios x-edit" xid="radioGroup1" bind-itemset="using" bind-itemsetValue="ref('chooseId')" bind-itemsetLabel="ref('choose')"></span></div>
  </div>
  ...
  <label xid="label3" bind-text="using.val('answer')"><![CDATA[]]></label></div></div>
