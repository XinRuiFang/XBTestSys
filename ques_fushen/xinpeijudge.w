...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
   ...
   <div xid="div1" bind-text='$model.ques.val("id") +"."+$model.using.val("ques")' style="width:100%;height:100%;">
  </div>
  ...
  <label xid="label3" bind-text="using.val('answer')==&quot;1&quot;?&quot;正确√&quot;:&quot;错误×&quot;"><![CDATA[]]></label></div>
...
<div class="x-panel-bottom" xid="bottom1"> <div class="x-panel-bottom" xid="bottom1"><div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group-justified" tabbed="true" xid="buttonGroup1"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-icon-top" label="上一题" xid="button1" icon="icon-arrow-left-a" onClick="button1Click">
  ...
  </div></div></div><span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog2" title="提示" message="答案错误！"></span>
  ...
  <span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog7" type="OKCancel" message="您确定要退出答题？您下次可以从当前进度开始继续作答！" title="提示" onOK="messageDialog7OK"></span></div>