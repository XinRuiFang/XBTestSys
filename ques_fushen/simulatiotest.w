...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <label xid="label3" style="color:#2894ff;font-weight:200;width:90%;"><![CDATA[复审模拟考试单选为38道、判断为62道，请点击下面的按钮开始答题！]]></label></div>
  ...
  <span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog2" message="您确定不进行评分直接退出？此次答题不会记录至记录中！" title="提示" type="OKCancel" onOK="messageDialog2OK"></span>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog3" src="$UI/ques_fushen/marksms.w"></span></div>